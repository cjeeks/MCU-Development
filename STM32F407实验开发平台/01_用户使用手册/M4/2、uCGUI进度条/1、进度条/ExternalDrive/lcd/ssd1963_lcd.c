...
{	
	...
	Timing_read.FSMC_AddressSetupTime = 10;  /* [3:0] F2/F4 1~15 HCLK */
	Timing_read.FSMC_AddressHoldTime = 5;   /* [7:4] keep 0x00 in SRAM mode */
	Timing_read.FSMC_DataSetupTime = 10;     /* [15:8] F2/F4 0~255 HCLK */
	/* [19:16] Time between NEx high to NEx low (BUSTURN HCLK) */
	Timing_read.FSMC_BusTurnAroundDuration = 5;
	...
	Timing_write.FSMC_AddressHoldTime = 5;   /* [7:4] keep 0x00 in SRAM mode */
	Timing_write.FSMC_DataSetupTime = 5;     /* [15:8] F2/F4 0~255 HCLK */
	/* [19:16] Time between NEx high to NEx low (BUSTURN HCLK) */
	Timing_write.FSMC_BusTurnAroundDuration = 5;
...
{       
#define MAX_CHAR_POSX (MAX_HZ_POSX-8)
#define MAX_CHAR_POSY (MAX_HZ_POSY-16) 
    u8 temp;
    u8 pos,t;
