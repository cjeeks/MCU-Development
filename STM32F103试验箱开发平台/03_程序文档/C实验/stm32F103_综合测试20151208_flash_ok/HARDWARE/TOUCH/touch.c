...
{	  
	POINT_COLOR=RED;
	LCD_ShowString(40, 160, "x1:");
 	LCD_ShowString(40+80, 160, "y1:");
 	LCD_ShowString(40,180, "x2:");
 	LCD_ShowString(40+80, 180, "y2:");
	LCD_ShowString(40,200,"x3:");
 	LCD_ShowString(40+80,200,"y3:");
	LCD_ShowString(40,220,"x4:");
 	LCD_ShowString(40+80,220,"y4:");  
 	LCD_ShowString(40,240,"fac is:");     
...
{								 
	...
	LCD_Clear(WHITE);//清屏 	   
	POINT_COLOR=BLACK;
	LCD_ShowString(40,40,(u8*)TP_REMIND_MSG_TBL);//显示提示信息
				...
				case 4:	 //全部四个点已经得到
					...
					if(abs(tp_dev.xfac)>2||abs(tp_dev.yfac)>2)//触屏和预设的相反了.
					{
						cnt=0;
 				    	TP_Drow_Touch_Point(lcddev.width-20,lcddev.height-20,WHITE);	//清除点4
   	 					TP_Drow_Touch_Point(20,20,RED);								//画点1
						LCD_ShowString(40,26, "TP Need readjust!");
