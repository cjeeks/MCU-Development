...
{
    SYSCTL_PERIPH2_UART0, SYSCTL_PERIPH2_UART1, SYSCTL_PERIPH2_UART2 , SYSCTL_PERIPH_UART3, SYSCTL_PERIPH_UART4, SYSCTL_PERIPH_UART5, SYSCTL_PERIPH_UART6  , SYSCTL_PERIPH_UART7
};
...
//
//*****************************************************************************
void UARTStdioInit(unsigned long ulPortNum, unsigned int baud)
{
    //
    // Pass this call on to the version of the function allowing the baud rate
    // to be specified.
    //
    UARTStdioInitExpClk(ulPortNum, baud);
}
...
UARTStdioInitExpClk(unsigned long ulPortNum, unsigned long ulBaud)
{
    ...
    ASSERT((ulPortNum == 0) || (ulPortNum == 1) ||
           (ulPortNum == 2)||(ulPortNum == 3)||(ulPortNum == 4)||(ulPortNum == 5)||(ulPortNum == 6)||(ulPortNum == 7));
...
//!
//! \return Returns the count of characters written. 输入字符串
//
//*****************************************************************************
int
...
//!
//! \return Returns the character read.	  接收字符
//
//*****************************************************************************
unsigned char
UARTgetc(void)
