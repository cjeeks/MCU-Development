...
//上拉电阻使能
#define KEY1_PULLUP do{P7REN|=BIT7;}while(0)
#define KEY1_OUT_H do{P7OUT|=BIT7;}while(0)
#define KEY1_IN     (P7IN&BIT7)
#define KEY1_INPUT do{P7DIR&=~BIT7;}while(0)
#define IS_KEY1_DOWN ((P7IN&BIT7)==0)
