...
*/
//for LED ARRAY
#define DATA_DIROUT   do{P1DIR|=BIT0;}while(0)
#define DATA_LOW      do{P1OUT&=~BIT0;}while(0)
#define DATA_HIGH     do{P1OUT|=BIT0;}while(0) //

#define C_DIROUT   do{P10DIR|=BIT7;}while(0)
#define C_LOW      do{P10OUT&=~BIT7;}while(0)
#define C_HIGH     do{P10OUT|=BIT7;}while(0)//

#define G_DIROUT   do{P1DIR|=BIT5;}while(0)
#define G_LOW      do{P1OUT&=~BIT5;}while(0)
#define G_HIGH     do{P1OUT|=BIT5;}while(0)//

#define D_DIROUT   do{P8DIR|=BIT5;}while(0)
#define D_LOW      do{P8OUT&=~BIT5;}while(0)
#define D_HIGH     do{P8OUT|=BIT5;}while(0)//

#define A_DIROUT   do{P8DIR|=BIT6;}while(0)
#define A_LOW      do{P8OUT&=~BIT6;}while(0)
#define A_HIGH     do{P8OUT|=BIT6;}while(0)//

#define LATCH_DIROUT   do{P11DIR|=BIT2;}while(0)
#define LATCH_LOW      do{P11OUT&=~BIT2;}while(0)
#define LATCH_HIGH     do{P11OUT|=BIT2;}while(0) //

#define B_DIROUT   do{P8DIR|=BIT4;}while(0)
#define B_LOW      do{P8OUT&=~BIT4;}while(0)
#define B_HIGH     do{P8OUT|=BIT4;}while(0) //

#define CLK_DIROUT   do{P11DIR|=BIT0;}while(0)
#define CLK_LOW      do{P11OUT&=~BIT0;}while(0)
#define CLK_HIGH     do{P11OUT|=BIT0;}while(0) //
