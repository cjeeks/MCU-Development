...
//DIO FOR OUTPUT
#define DDDIO_DIROUT do{P8DIR|=BIT3;}while(0)
#define DDDIO_OFF do{P8OUT&=~BIT3;}while(0)
#define DDDIO_ON do{P8OUT|=BIT3;}while(0)

//DIO FOR INPUT
#define DDDIO_PULLUP do{P8REN|=BIT3;}while(0)
#define DDDIO_OUT_H  do{P8OUT|=BIT3;}while(0)
#define DDDIO_IN (P8IN&BIT3)
